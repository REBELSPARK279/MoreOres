...
public enum ModArmorMaterials implements ArmorMaterial {
    TITANIUM("titanium", 18, new int[]{ 3, 7, 5, 2 }, 25,
            SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, () -> Ingredient.of(ModItems.TITANIUM_PIECE.get())),
    COPPER("copper", 13, new int[]{ 2, 4, 3, 2 }, 13,
            SoundEvents.ARMOR_EQUIP_CHAIN, 0f, 0f, () -> Ingredient.of(Items.COPPER_INGOT));
